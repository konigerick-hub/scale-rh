...
export const Acao = {
  ...
  /** Contratos comerciais: quem emitiu para qual cliente, e por qual empresa. */
  MODELO_COMERCIAL_SALVAR: 'modelo_comercial.salvar',
  MODELO_COMERCIAL_REMOVER: 'modelo_comercial.remover',
  COMERCIAL_GERAR: 'comercial.gerar',
  COMERCIAL_BAIXAR: 'comercial.baixar',
